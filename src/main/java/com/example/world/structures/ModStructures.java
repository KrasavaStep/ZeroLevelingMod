package com.example.world.structures;

import com.example.ZeroLevelingMod;
import com.example.world.structures.overworld.SkyStructures;
...
public class ModStructures {
    ...
    public static void registerStructureFeatures() {
        SKY_STRUCTURES = Registry.register(Registries.STRUCTURE_TYPE, new Identifier(ZeroLevelingMod.MOD_ID, "sky_structures"), () -> SkyStructures.CODEC);
    }
}